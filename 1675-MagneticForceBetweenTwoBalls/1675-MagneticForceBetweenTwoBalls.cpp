// Last updated: 8/9/2026, 12:05:28 AM
class Solution {
public:
    int maxDistance(vector<int>& position, int m) {
        // force is bound between the min and maximum value of the position of
        // the positions array find minimum distance that is maxmimized across
        // others
